<table cellpadding="2" cellspacing="1" width="98%">
    ...
    <tr>
        <td>允许上传的图片大小</td>
        <td><input type="text" name="setting[upload_maxsize]" value="<?php echo isset($setting['upload_maxsize']) ? $setting['upload_maxsize'] : '';?>" size="5" class="input-text">KB 提示：1KB=1024Byte，1MB=1024KB *</td>
    </tr>
    <tr>
        <td>允许上传的图片类型</td>
    ...
    <tr>
        <td>JS回调方法</td>
        <td><input type="text" name="setting[js_callback]" value="<?php echo isset($setting['js_callback']) ? $setting['js_callback'] : '' ;?>" /></td>
    </tr>
    <tr>
        <td>图像大小</td>
