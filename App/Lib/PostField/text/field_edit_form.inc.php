<table cellpadding="2" cellspacing="1" width="98%">
  ...
  <tr>
    <td>是否为隐藏框</td>
    <td><input type="radio" name="setting[ishidden]" value="1" <?php if(isset($setting['ishidden']) && $setting['ishidden']) echo 'checked';?>> 是 <input type="radio" name="setting[ishidden]" value="0" <?php if(!isset($setting['ishidden']) || !$setting['ishidden']) echo 'checked';?>> 否</td>
  </tr>
</table>