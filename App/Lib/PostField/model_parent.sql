...
INSERT INTO `$table_model_field` (`modelid`, `siteid`, `field`, `name`, `tips`, `css`, `minlength`, `maxlength`, `pattern`, `errortips`, `formtype`, `setting`, `formattribute`, `iscore`, `issystem`, `isunique`, `isbase`, `issearch`, `isadd`, `listorder`, `disabled`, `isomnipotent`) VALUES($modelid, $siteid, 'post_type', '类别', '', '', 0, 0, '', '', 'text', '', '', 1, 1, 0, 1, 0, 0, 23, 0, 0);
