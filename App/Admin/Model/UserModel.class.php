...
class UserModel extends Model
{
    public function adminList() {
        $sql = "SELECT user.*, role.name, role.id as role_id FROM __PREFIX__user AS user, __PREFIX__role AS role, __PREFIX__role_user as ru WHERE user.id = ru.user_id and ru.role_id = role.id ORDER BY user.id ASC";
        $list = $this->query($sql);
        return $list;
    }
