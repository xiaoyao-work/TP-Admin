...
function load_runtime_file() {
    ...
    // 读取核心文件列表
    $list = array(
		//[cluster] 加载Think.class.php
        CLUSTER_PATH.'Lib/Core/Think.class.php',
	...
	if(APP_DEBUG && ThinkFS::file_exists(RUNTIME_FILE)) ThinkFS::unlink(RUNTIME_FILE);
}
