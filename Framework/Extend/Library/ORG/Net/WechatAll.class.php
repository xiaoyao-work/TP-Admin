...
class WechatAll
{
  ...
  private function log($log) {
    ...
    if ($this->debug && method_exists($this, $this->_logcallback)) {
      if (is_array($log)) $log = print_r($log,true);
      return call_user_func(array($this, $this->_logcallback),$log);
    }
  }

  public function logdebug($text) {
    file_put_contents(RUNTIME_PATH.'Logs/weixin.log',$text."\n",FILE_APPEND);
  }
