...
return $str;
  ...
  public static function images($name, $id = '', $value = '', $moudle='', $catid='', $size = 50, $class = '', $ext = '', $alowexts = '',$thumb_setting = array(),$watermark_setting = 0 ) {
    ...
    return $str."<input type=\"text\" name=\"$name\" id=\"$id\" value=\"$value\" size=\"$size\" class=\"$class\" $ext/>  <input type=\"button\" class=\"button\" onclick=\"javascript:attachupload('{$id}_images', '".L('attachmentupload')."','{$id}',attaches,'1,{$alowexts},1,{$thumb_ext},{$watermark_setting}','images','". U('Upfile/upload') ."')\"/ value=\"".L('imagesupload')."\">";
  }
