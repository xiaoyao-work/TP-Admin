...
class Util {
     ...
     * @param \Think\Http\Headers $headers The Response headers
     * @param \Think\Http\Cookies $cookies The Response cookies
     * @param array              $config  The Slim app settings
     */
    public static function serializeCookies(\Think\Http\Headers &$headers, \Think\Http\Cookies $cookies, array $config) {
