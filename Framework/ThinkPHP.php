...
defined('DOC_PATH')     || define('DOC_PATH', ROOT_PATH . 'public/');
...
defined('RUNTIME_PATH')     || define('RUNTIME_PATH', DOC_PATH . 'Runtime/');  // 系统运行时目录
...
if (!IS_CLI) {
    defined('_PHP_FILE_') || define('_PHP_FILE_', rtrim($_SERVER['SCRIPT_NAME'], '/'));
    $_root = rtrim(dirname(_PHP_FILE_), '/');
    defined('__ROOT__') || define('__ROOT__', (($_root == '/' || $_root == '\\') ? '' : $_root));
}
